package com.springboot.backend.luchin.userapp.user_backend.controllers;
...
import com.springboot.backend.luchin.userapp.user_backend.services.UserService;
...
public class UserController {
    ...
    public ResponseEntity<?> show(@PathVariable Long id) {
        ...
        if(userOptional.isPresent()){
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Collections.singletonMap("error","El usuario no es encontro por el id "+id));
        }
    }
    @PostMapping
